...
```{r}
# Q1 plots
# This is a viable solution, that may have to be ggarranged, does not require
# calculating frequencies and proportions

```

```{r}
# Will need two data sets, overall, and then by clinician provider
...
#   geom_bar(stat = "prop", position = position_dodge2(width = 0.9, preserve = "single")) +
